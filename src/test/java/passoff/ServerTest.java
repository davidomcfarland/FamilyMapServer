...
public class ServerTest {
     ...
     */
    @Test
    @DisplayName("Person Wrong model.User Test")
     ...
     */
    @Test
    @DisplayName("Event Wrong model.User Test")
    ...
    public void testRealisticBirthEvents(TestInfo testInfo) {
        ...
        try {
            ...
            assertNotNull(userPerson, "model.User's Person not included in passoffresult");
    ...
    public void testRealisticDeathEvents(TestInfo testInfo) {
        ...
        try {
            ...
            assertNotNull(userFather, "model.User's Father's Person not included in passoffresult");
            //If person3 is null then a Person Object was not created for the user's mother and inserted into the database
            assertNotNull(userMother, "model.User's Mother's Person not included in passoffresult");
